...
Java_com_myapplication_MainActivity_getApiKey(JNIEnv *env, jobject instance) {
    return (*env)-> NewStringUTF(env, "ABCDEFGHIJKLMNOPQRSTUVWXYZ");
}
...
JNIEXPORT jstring JNICALL
Java_com_myapplication_MainActivity_encodeToBase64(JNIEnv *env, jobject obj, jstring jInput) {
    // Step 1: Base64 encode "TicketSimply"
...
JNIEXPORT jstring JNICALL
Java_com_myapplication_MainActivity_decodeFromBase64(JNIEnv *env, jobject obj, jstring jEncoded) {
